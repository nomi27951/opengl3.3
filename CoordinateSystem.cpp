...
int main()
{
	...
	//bind this texture object to texture buffer
	...
	if (data)
	{
		//load texture image onto texture object
	...
	//tell shader sampler about texture units
	ourShader.use();
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		view = glm::lookAt(glm::vec3(camX, 0.0, camZ), glm::vec3(0, 0, 0), glm::vec3(0, 1, 0));*/
		view = glm::lookAt(cameraPos, cameraPos + cameraFront, cameraUp);
		projection = glm::perspective(glm::radians(45.0f), (float)SCR_WIDTH / (float)SCR_HEIGHT, 0.1f, 100.0f);

		//retriev matrix unifrom location
		unsigned int modelLoc = glGetUniformLocation(ourShader.ID, "model");
		unsigned int viewLoc = glGetUniformLocation(ourShader.ID, "view");

		//pass these matrices to shader
		...
		for (unsigned int i = 0; i < 10; i++)
		{
			...
			float angle = i * 20.0f;
			model = glm::rotate(model, glm::radians(angle), glm::vec3(1.0f, 0.4f, 0.7f));
