...
int main()
{
	...
	glfwWindowHint(GLFW_OPENGL_FORWARD_COMPAT, GL_TRUE); // uncomment this statement to fix compilation on OS X
														 ...
														 // --------------------
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "LightsCaster", NULL, NULL);
	if (window == NULL)
	{
	...
	// ------------------------------------
	Shader lightingShader = Shader("lights.vs", "PointLight.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// light properties
		lightingShader.setVec3f("light.ambient", glm::vec3(0.1f));
